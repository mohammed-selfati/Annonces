    ...
    <nav class="navbar navbar-expand-md bg-dark sticky-top navbar-light pt-2 pb-2 ">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
              ...
              <li class="nav-item">
                  <button id="btn_inscription" onclick="window.location.href='inscription.html'" class="mr-3  ml-3"  type="submit">Sinscrire</button>
              </li>

              <li class="nav-item">
                  <button  id="btn_connect" onclick="window.location.href='SeConnect.php'" class="mr-3  ml-3"  type="submit">connecter</button>
              </li>
...
<!--slider-->
            ...
            <div class="row mt-5">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default modal-btn-annuler" data-dismiss="modal">Annuler</button>  
              </div>
            </div>
          </div>
        </div>
